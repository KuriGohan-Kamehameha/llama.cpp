            ...
            case GGML_TYPE_Q4_1:
                {
                    ...
                    if (use_esimd_q4_1 && (ne00 % (QK4_1 * 8) == 0)) {
                        ...
                        extern void mul_mat_vec_q4_1_q8_1_sycl_esimd(
                            const void *, const void *, float *, int, int, dpct::queue_ptr);
                        mul_mat_vec_q4_1_q8_1_sycl_esimd(
                            src0_dd_i, src1_ddq_i_bs, dst_dd_i_bs, ne00, row_diff, stream);
                    } else
#endif
                    {
            ...
            case GGML_TYPE_Q5_1:
                {
                    ...
                    if (use_esimd_q5_1 && (ne00 % (QK5_1 * 8) == 0)) {
                        ...
                        extern void mul_mat_vec_q5_1_q8_1_sycl_esimd(
                            const void *, const void *, float *, int, int, dpct::queue_ptr);
                        mul_mat_vec_q5_1_q8_1_sycl_esimd(
                            src0_dd_i, src1_ddq_i_bs, dst_dd_i_bs, ne00, row_diff, stream);
                    } else
#endif
                    {
                ...
                if ((ggml_tensor_extra_gpu *) dst->src[0]->extra &&
                    ...
                    if (use_esimd_q8_0 && (ne00 % (QK8_0 * 8) == 0)) {
                        ...
                        extern void reorder_mul_mat_vec_q8_0_q8_1_sycl_esimd(
                            const void *, const void *, float *, int, int, dpct::queue_ptr);
                        reorder_mul_mat_vec_q8_0_q8_1_sycl_esimd(
                            src0_dd_i, src1_ddq_i_bs, dst_dd_i_bs, ne00, row_diff, stream);
                    } else
#endif
                    {
            ...
            case GGML_TYPE_Q2_K:
                {
                    ...
                    if (use_esimd_q2_k) {
                        ...
                        extern void mul_mat_vec_q2_k_q8_1_sycl_esimd(
                            const void *, const void *, float *, int, int, dpct::queue_ptr);
                        mul_mat_vec_q2_k_q8_1_sycl_esimd(
                            src0_dd_i, src1_ddq_i_bs, dst_dd_i_bs, ne00, row_diff, stream);
                    } else
#endif
                    {
            ...
            case GGML_TYPE_Q5_K:
                {
                    ...
                    if (use_esimd_q5_k) {
                        ...
                        extern void mul_mat_vec_q5_k_q8_1_sycl_esimd(
                            const void *, const void *, float *, int, int, dpct::queue_ptr);
                        mul_mat_vec_q5_k_q8_1_sycl_esimd(
                            src0_dd_i, src1_ddq_i_bs, dst_dd_i_bs, ne00, row_diff, stream);
                    } else
#endif
                    {
                ...
                if ((ggml_tensor_extra_gpu *) dst->src[0]->extra &&
                    ...
                    if (use_esimd_q6_k) {
                        ...
                        extern void reorder_mul_mat_vec_q6_k_q8_1_sycl_esimd(
                            const void *, const void *, float *, int, int, dpct::queue_ptr);
                        reorder_mul_mat_vec_q6_k_q8_1_sycl_esimd(
                            src0_dd_i, src1_ddq_i_bs, dst_dd_i_bs, ne00, row_diff, stream);
                    } else
#endif
                    {
